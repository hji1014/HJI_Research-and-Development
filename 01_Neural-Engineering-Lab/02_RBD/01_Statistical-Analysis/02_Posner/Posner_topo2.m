...
for folder_num = 3:subject_num
    ...
    for i = 1:size(valid_1000, 3)
        ...
        [grid_or_val, plotrad_or_grid] = topoplot(all_ch_val_1000, chanlocs,'noplot','on');
        topo = flipud(plotrad_or_grid);
        
        % all_trial
        all_ch_tr_val_1000(i, :, :) = topo;
    end
    ...
    for i = 1:size(invalid_1000, 3)
        ...
        %si_N1_90 = rot90(si_N1);
        [grid_or_val, plotrad_or_grid] = topoplot(all_ch_inval_1000, chanlocs,'noplot','on');
        topo = flipud(plotrad_or_grid);
        
        % all_trial
        all_ch_tr_inval_1000(i, :, :) = topo;
    end
    ...
    for i = 1:size(valid_200, 3)
        ...
        %si_N1_90 = rot90(si_N1);
        [grid_or_val, plotrad_or_grid] = topoplot(all_ch_val_200, chanlocs,'noplot','on');
        topo = flipud(plotrad_or_grid);
                        
        % all_trial
        all_ch_tr_val_200(i, :, :) = topo;
    end
    ...
    for i = 1:size(invalid_200, 3)
        ...
        %si_N1_90 = rot90(si_N1);
        [grid_or_val, plotrad_or_grid] = topoplot(all_ch_inval_200, chanlocs,'noplot','on');
        topo = flipud(plotrad_or_grid);
                        
        % all_trial
        all_ch_tr_inval_200(i, :, :) = topo;
    end
...
%save('CON_topo2', 'all_sub_CON', '-v7.3')
save('RBD_topo2', 'all_sub_RBD', '-v7.3')