%% 예전 코드
%EEG_data_all_trial_avg = mean(EEG_data, 3);
%EEG_data_all_ch_avg = mean(EEG_data_all_trial_avg, 1);
%
%fs = 400;
%Fs = fs;
%Ts = 1/Fs;
%F_upper_bound = 50;
%num = 5;
%y=cwt_cmor_norm_var_cycd(EEG_data_all_ch_avg,Ts,F_upper_bound, num);
%
%imagesc(abs(y));axis xy;colormap('jet');
