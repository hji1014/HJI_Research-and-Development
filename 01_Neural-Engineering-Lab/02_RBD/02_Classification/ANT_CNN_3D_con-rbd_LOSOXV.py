...
for train_idxs, test_idxs in cv.split(con_rbd, con_rbd_label, groups):
    ...
    history = model.fit(con_rbd[train_idxs], con_rbd_label_one_hot_encoding[train_idxs], epochs=20, batch_size=128, verbose=2, callbacks=[early_stopping_callback])
...
# 필요한 정보들 저장
np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/random_rbd_idx.npy', random_rbd_idx)         # rbd 24명 환자번호 저장
np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/con_rbd.npy', con_rbd)                       # con-rbd data 저장
np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/con_rbd_label.npy', con_rbd_label)           # con-rbd label 저장
np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/groups.npy', groups)                         # con-rbd 피험자 번호 순서 저장
np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/np_acc.npy', np_acc)                         # test 정확도 저장
#np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/np_train_acc.npy', np_train_acc)                   # train 정확도 저장
np.save('D:/ANT_3D_CNN/ANT_topo/LOSOXV_random_selection_sub_48/test_idx_order.npy', test_idx_order)         # test 피험자 번호 순서 저장
