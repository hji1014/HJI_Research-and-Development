...
for i in fold_num:
    ...
    model.load_weights('C:/Users/Nelab_001/PycharmProjects/pythonProject/ANT_CNN_3D_con-rbd_model_10-fold_weights/ANT_CNN_3D_con-rbd_%i.h5' % i)
    ...
    np.save('C:/Users/Nelab_001/Documents/MATLAB/RBD_ANT/1.LRP/20220204_con-rbd_LRP/LRP_TP_mean_fold%i.npy' % i, analysed_results_TN_mean)
    np.save('C:/Users/Nelab_001/Documents/MATLAB/RBD_ANT/1.LRP/20220204_con-rbd_LRP/LRP_TN_mean_fold%i.npy' % i, analysed_results_TP_mean)

    #del model, y_predict, y_predict_con, y_predict_rbd, y_predict_class, incorrect_index, incorrect_y_test,\
    #    incorrect_x_test, incorrect_index_con, incorrect_index_rbd, incorrect_x_test_con, incorrect_x_test_rbd,\
    #    model_wo_softmax, analyzer, TN, analysed_results_TN, analysed_results_TN_mean, TP, analysed_results_TP, analysed_results_TP_mean

    del model, y_predict, y_predict_con, y_predict_rbd, y_predict_class, \
        model_wo_softmax, analyzer, TN, analysed_results_TN, analysed_results_TN_mean, TP, analysed_results_TP, analysed_results_TP_mean
