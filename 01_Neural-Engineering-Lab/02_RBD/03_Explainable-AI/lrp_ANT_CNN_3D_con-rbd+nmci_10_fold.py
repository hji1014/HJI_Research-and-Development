...
for fold in range(10):
    ...
    model.summary()
    model.load_weights('D:/ANT_3D_CNN_con-rbd+nmci/weights/model_weights_fold_%d.h5' % (fold + 1))

    x_test = np.load('D:/ANT_3D_CNN_con-rbd+nmci/testset/x_fold_%d.npy' % (fold + 1))
    y_test = np.load('D:/ANT_3D_CNN_con-rbd+nmci/testset/y_fold_%d.npy' % (fold + 1))
    ...
    np.save('D:/ANT_3D_CNN_con-rbd+nmci/LRP/LRP_TP_fold_%d.npy' % (fold + 1), TP)
